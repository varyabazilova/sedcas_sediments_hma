...
path = 'D:\\climatedata\\era5land\\Mustang\\temp\\*.nc'
...
gridcell = file.sel(latitude=28.7, longitude=83.7, method='nearest')
print(gridcell)

# select time
start_date = '1951-01-01T00:00:00.000000000'
...
cutdf = cutdf.rename(columns={'t2m': 'Ta'})
cutdf.index.name = 'D'

cutdf[['Ta']].to_csv("D:\climatedata\merge\Ta.csv")